...
namespace ACCEntryListGenerator
{
    public static class CarModelUtility
    {
        ...
        private static Dictionary<ECarModel, string> carModelReadableNamePerEnum = new Dictionary<ECarModel, string>()
        {
            ...
            {ECarModel.Audi_R8_LMS_GT3_Evo_2, "Audi R8 LMS GT3 Evo 2 (2022)"},
            ...
            {ECarModel.BMW_M2_Club_Sport_Racing, "BMW M2 Club Sport Racing (2020)"},
            {ECarModel.BMW_M4_GT3, "BMW M4 GT3 (2022)"},
            ...
            {ECarModel.Ferrari_296_GT3, "Ferrari 296 GT3 (2023)"},
            {ECarModel.Ferrari_488_Challenge_Evo, "Ferrari 488 Challenge Evo (2020)"},
            ...
            {ECarModel.Lamborghini_Huracan_Evo2, "Lamborghini Huracan Evo2 (2023)"},
            {ECarModel.Lamborghini_Huracan_GT3_2015, "Lamborghini Huracan GT3 (2015)"},
            {ECarModel.Lamborghini_Huracan_GT3_Evo_2019, "Lamborghini Huracan GT3 Evo"},
            {ECarModel.Lamborghini_Huracan_SuperTrofeo_2015, "Lamborghini Huracan SuperTrofeo (2015)"},
            {ECarModel.Lamborghini_Huracán_SuperTrofeo_EVO2, "Lamborghini Huracán SuperTrofeo EVO2 (2021)"},
            ...
            {ECarModel.Porsche_911_II_GT3_R_2019, "Porsche 911 II GT3 R (2019)"},
            {ECarModel.Porsche_991_GT3_R_2018, "Porsche 991 GT3 R (2018)"},
            {ECarModel.Porsche_991_II_GT3_Cup_2017, "Porsche 991 II GT3 Cup (2017)"},
            {ECarModel.Porsche_992_GT3_Cup, "Porsche 992 GT3 Cup (2021)"},
            {ECarModel.Porsche_992_GT3_R, "Porsche 992 GT3 R (2023)"},
